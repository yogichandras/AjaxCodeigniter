...
class Mymodel extends CI_Model {
	...
	function get_all_user() { //ambil data barang dari table barang yang akan di generate ke datatable
        ...
        $this->datatables->add_column('view', '<a href="javascript:void(0);" class="edit_record btn btn-info btn-xs" data-id="$1">Edit</a>  <a href="javascript:void(0);" class="hapus_record btn btn-danger btn-xs" data-id="$1">Hapus</a>','id,username,password,status');
  ...
  function get_surat_masuk() { //ambil data barang dari table barang yang akan di generate ke datatable
	...
	$this->datatables->add_column('view', '<a href="javascript:void(0);" class="edit_record btn btn-info btn-xs" data-id="$1">Edit</a>  <a href="javascript:void(0);" class="hapus_record btn btn-danger btn-xs" data-no_surat="$1">Hapus</a>','no_surat,tanggal_masuk,tanggal_keluar,perihal,lampiran,tujuan,dari,content');
	return $this->datatables->generate();
}
